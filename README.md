...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-14 20:45`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a298f7d7-eb66-4934-a363-80a3dd95f6d9.git
$ cd a298f7d7-eb66-4934-a363-80a3dd95f6d9
```
